...
osThreadId pressure_data_cHandle;
osThreadId temp_data_colleHandle;
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_pressure_data_c_init */
/**
  * @brief  Function implementing the pressure_data_c thread.
...
/* USER CODE BEGIN Header_temp_data_collect_init */
/**
* @brief Function implementing the temp_data_colle thread.
* @param argument: Not used
* @retval None
*/
